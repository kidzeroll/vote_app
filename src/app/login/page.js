...
export default function Login() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-10 space-y-10">
            ...
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
                <button
                    ...
                    className="inline-flex items-center justify-center w-full py-2 font-medium border border-rose-500 hover:bg-slate-800">
                    {googleIcon}
                    <span className="ml-2">Login dengan Google</span>
                </button>
            </div>
        </div>
    );
